...
$fileDuck->add(__DIR__ .'/../prototype/plugins/linkify/ba-linkify.min.js');
$fileDuck->add(__DIR__ .'/../prototype/plugins/sort/jquery.tinysort.min.js');
$fileDuck->add(__DIR__ .'/../prototype/plugins/sort/jquery.tinysort.charorder.min.js');
$fileDuck->add(__DIR__ .'/../prototype/plugins/sort/jquery.opensource.min.js');
